...
namespace CLEANSHOP.Models
{
    ...
    partial void DeleteProduct(Product instance);
		...
		public MydataDataContext() : 
				base(global::System.Configuration.ConfigurationManager.ConnectionStrings["CLEANSHOPConnectionString"].ConnectionString, mappingSource)
		{
			OnCreated();
		}
	...
	public partial class Cart : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<bool> _TotalPrice;
    ...
    partial void OnTotalPriceChanging(System.Nullable<bool> value);
    ...
    partial void OnDeliveryChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_TotalPrice", DbType="Bit")]
		public System.Nullable<bool> TotalPrice
		{
			get
			{
			...
			set
			{
							...
							|| (this._Product.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.CartDetail = null;
					}
					this._Product.Entity = value;
					if ((value != null))
					{
						value.CartDetail = this;
    ...
    partial void OnAmountChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Detail", DbType="NVarChar(500) NOT NULL", CanBeNull=false)]
		...
		public CartDetail CartDetail
		{
			get
			{
				return this._CartDetail.Entity;
			}
			set
			{
				CartDetail previousValue = this._CartDetail.Entity;
				if (((previousValue != value) 
							|| (this._CartDetail.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._CartDetail.Entity = null;
						previousValue.Product = null;
					}
					this._CartDetail.Entity = value;
					if ((value != null))
					{
						value.Product = this;
					}
					this.SendPropertyChanged("CartDetail");
				}
			}
		}
